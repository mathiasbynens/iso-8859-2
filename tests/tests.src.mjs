...
assert.deepStrictEqual(
	iso88592.decode(new Uint16Array([0xFFFF])),
	'\uFFFD',
...
assert.deepStrictEqual(
	iso88592.decode(new Uint16Array([0xFFFF]), { mode: 'replacement' }),
	'\uFFFD',
...
assert.throws(
	() => {
		iso88592.decode(new Uint16Array([0xFFFF]), { mode: 'fatal' });
	},
	Error,
